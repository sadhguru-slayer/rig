 ...
 */
// tiptap-utils.js
export const handleImageUpload = async (file, onProgress, setUploadedFilesMap) => {
  ...
  // Create local preview for TipTap
  const localPreview = URL.createObjectURL(file);

  // Save file in uploadedFilesMap for server upload
  ...
  // Return node data for TipTap: preview + filename key
  return localPreview
};

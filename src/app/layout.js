...
export const metadata = {
  ...
  description: "Premium invisible grills for balconies, windows, and facades—engineered for safety, durability, and elegant aesthetics.",
  icons: {
    icon: '../../public/logo_c.png', // Ensure this path is correct
    shortcut: '../../public/logo_c.png', // Optional, but you can use a smaller icon
    apple: '../../public/logo_c.png', // Optional for Apple devices
  },
};

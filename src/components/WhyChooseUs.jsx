    ...
    <section id="why" className="py-16 lg:py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-teal-700">Why Choose Us</h2>
        ...
        <div className="mt-10 grid lg:grid-cols-2 gap-8">
          {/* Traditional vs Invisible comparison */}
        ...
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="rounded-lg border border-gray-200 p-5">
            ...
            <p className="mt-2 text-sm text-gray-600">Clean lines and unobstructed views enhance interiors and exteriors.</p>
          </div>
          <div className="rounded-lg border border-gray-200 p-5">
            <h4 className="font-medium text-teal-700">Safety</h4>
            <p className="mt-2 text-sm text-gray-600">High-tensile SS cables and reliable anchoring for child-safe protection.</p>
          </div>
          <div className="rounded-lg border border-gray-200 p-5">
            <h4 className="font-medium text-teal-700">Practicality</h4>
            <p className="mt-2 text-sm text-gray-600">Low maintenance, quick installation, easy to clean and inspect.</p>
          </div>
        </div>
      </div>
    </section>
